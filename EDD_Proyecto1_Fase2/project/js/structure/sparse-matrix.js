...
class sparseMatrix{
    ...
    graph(){
        ...
        code +="M0[ label = \"DOCUMENTOS\" width = 1.5 shape = \"none\" style = \"filled\"  group=\"0\"]; \n";
    ...
    #headersGraph(){
        ...
        while(temp != null){
            nodes += "Y" + temp.value + `[label="${temp.yValue}" width = 1.5 shape ="none" style="filled" fillcolor="skyblue3" group = ${temp.value} ];\n`
            rank += "Y" + temp.value + ";";
            if(temp.right != null){
                conn += "Y" + temp.value + "->";
            }else{
        ...
        while(temp != null){
            console.log(temp)
            nodes += "X" + temp.value + `[label="${temp.xValue}" width = 1.5 shape ="none" style="filled" fillcolor="skyblue3" group="0"];\n`
            if(temp.down != null){
                conn += "X" + temp.value + "->";
            }else{
    ...
    #nodesGraph(){
        ...
        while(tx != null){
            ...
            conn += `X${ty.x} -> `
            while(ty != null){
                nodes += `S${ty.x}_${ty.y}[label="${ty.value}" width=1.5 shape="none" style="filled" fillcolor="slategray1" group="${ty.y}"];\n`
